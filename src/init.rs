...
# Generated by pd v{PD_VERSION} — re-run `pd init bash` after updating
# Add to ~/.bashrc:
#   eval "$(pd init bash)"
...
# Generated by pd v{PD_VERSION} — re-run `pd completions bash` after updating
...
# Generated by pd v{PD_VERSION} — re-run `pd init nu` after updating
...
# Generated by pd v{PD_VERSION} — re-run `pd completions nu` after updating
...
# Generated by pd v{PD_VERSION} — re-run `pd init pwsh` after updating
# Add to $PROFILE:
...
# Generated by pd v{PD_VERSION} — re-run `pd completions pwsh` after updating
